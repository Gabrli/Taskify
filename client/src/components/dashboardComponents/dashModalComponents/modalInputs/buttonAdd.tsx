...
export default function ButtonAdd(props: {
  ...
  return (
    <button
      ...
      className="transition duration-700 ease-in-out bg-white text-white font-semibold bg-opacity-20 h-custom-height-modal-inputs rounded w-modalInputs hover:bg-opacity-30"
    >
      Save
    </button>
  );
